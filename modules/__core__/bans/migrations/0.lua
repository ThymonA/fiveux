--
-- Create a `player_bans` table table for you
--
migration.query = [[
    CREATE TABLE `player_bans` (
        ...
        `previousBan` INT DEFAULT NULL,

        CONSTRAINT `fk_player_bans_parentBan` FOREIGN KEY (`parentBan`) REFERENCES `player_bans`(`id`),
        CONSTRAINT `fk_player_bans_previousBan` FOREIGN KEY (`previousBan`) REFERENCES `player_bans`(`id`),
        PRIMARY KEY (`id`)
    );
]]